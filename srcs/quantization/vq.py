...
class ResidualVectorQuantizer(nn.Module):
    ...
    def forward(self, x: torch.Tensor, sample_rate: int, bandwidth: tp.Optional[float] = None) -> QuantizedResult:
        ...
        """
        bw_per_q = self.get_bandwidth_per_quantizer(sample_rate) # bandwidth for this training batch
        n_q = self.get_num_quantizers_for_bandwidth(sample_rate, bandwidth) # number of quantizer to use in this training batch
