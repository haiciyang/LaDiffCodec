...
class UNet2D(Module):
    ...
    def __init__(self, inp_channels: int = 3, n_channels: int = 64,
                 ch_mults: Union[Tuple[int, ...], List[int]] = (1, 2, 2, 4),
                 is_attn: Union[Tuple[bool, ...], List[int]] = (False, False, True, True),
                 n_blocks: int = 2, self_condition=False, qtz_condition=False):
        """
        ...
        * `n_blocks` is the number of `UpDownBlocks` at each resolution
        ...
        self.image_proj = nn.Conv2d(inp_channels, n_channels, kernel_size=(3, 3), padding=(1, 1))
        ...
        self.act = Swish()
        self.final = nn.Conv2d(in_channels, inp_channels, kernel_size=(3, 3), padding=(1, 1))
